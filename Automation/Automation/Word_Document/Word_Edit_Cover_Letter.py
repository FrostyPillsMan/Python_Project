...
doc = DocxTemplate(
    "./Automation/Word_Document/Black_Style_Professional_Sales_Cover_Letter.docx"
)


name = "Adam"
phone_number = "(+60) 14-5690-4832"
...
doc.save("Automation/Word_Document/Generate_Doc_Edit.docx")
